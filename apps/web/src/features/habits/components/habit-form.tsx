...
export const HabitForm: React.FC<HabitFormProps> = ({ form, onSubmit, mutation, submitText }) => {
          ...
          render={({ field, fieldState }) => (
            <Field orientation="responsive" data-invalid={fieldState.invalid}>
              ...
              <Select name={field.name} value={field.value} onValueChange={field.onChange}>
                <SelectTrigger id="habit-color" aria-invalid={fieldState.invalid}>
                  ...
                  {Object.entries(colors).map(([name, className]) => (
                    <SelectItem key={name} value={name}>
                      <div className="flex items-center">
                        <div className={`w-2 h-2 rounded-full ${className} mr-2`} />
